        ...
        <main>
            <div class="container">
                <%
                    ...
                    listaSolicitudes = (ArrayList) request.getAttribute("listaSolicitudes");
                %>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row"><%=listaSolicitudes.get(i).getCod_solicitud()%></th>
                            <td><%=listaSolicitudes.get(i).getUsu_cli()%></td>
                            <td><%=listaSolicitudes.get(i).getAsunto()%></td>
                            <td><%=listaSolicitudes.get(i).getDescripcion()%></td>
                            <td><%=listaSolicitudes.get(i).getImagen()%></td>
                            <td><%=listaSolicitudes.get(i).getFecha_solicitud()%></td>
                            <td>
                                <input onclick="location.href = 'gestionarSolicitud.jsp?id=<%=listaSolicitudes.get(i).getCod_solicitud()%>'" type="button" class="btn btn-lg btn-block btn-primary" value="Ver"/>
                            </td>
                            <% if(listaSolicitudes.get(i).getEstado() == 0){ %>
                            <td>CERRADO</td>
                            <%}else{%><td>ABIERTO</td><%}%>
                        </tr>
                        <%}%>
