                ...
                <div id="capa0">
                    ...
                    <div id="capa1">
                        <form class="form-group" action="Controlador" method="post">
                            ...
                            <input type="text" class="form-control" name="txtusername" value="<%=bUsuario.getUsername()%>" id="" aria-describedby="" required focus>
                            <%}%>
                            <label for="">DNI</label>
                            <input type="text" class="form-control" name="txtdni" value="<%=bUsuario.getDni()%>" id="" aria-describedby="" required>
                            <label for="">Nombres</label>
                            <input type="text" class="form-control" name="txtnombre" value="<%=bUsuario.getNombres()%>" id="" aria-describedby="" required>
                            <label for="">Apellido Paterno</label>
                            <input type="text" class="form-control" name="txtapp" value="<%=bUsuario.getAp_paterno()%>" id="" aria-describedby="" required>
                            <label for="">Apellido Materno</label>
                            <input type="text" class="form-control" name="txtapm" value="<%=bUsuario.getAp_materno()%>" id="" aria-describedby="" required>
                            <label for="">Telefono</label>
                            <input type="text" class="form-control" name="txtcel" value="<%=bUsuario.getNumero()%>" id="" aria-describedby="" maxlength="9" required>
                            <label for="">Correo electronico</label>
                            <input type="text" class="form-control" name="txtcorreo" value="<%=bUsuario.getCorreo()%>" id="" aria-describedby="" required>
                            <label for="">Contraseña</label>
                            <input type="password" class="form-control" name="pwdclave" id="" aria-describedby="" required>
                            <br>
