...
<html>
    ...
    <body>
        ...
        <main>
            <div class="container">
                <div id="capa0">
                    <h1 id="titulo">Agregar nuevo producto</h1>
                    <hr>
                    <div id="capa1">
                        <form class="form-group" action="Controlador" method="post" enctype="multipart/form-data">
                            ...
                            <input type="text" class="form-control" name="txtnomprod" id="" aria-describedby="" required><br>
                            <label for="">Precio del producto</label>
                            <input type="number" class="form-control" name="nmbpreprod" id="" aria-describedby="" required><br>
                            <label for="">Subir la imagen</label>
                            <input type="file" name="fileimagen" class="form-control"><br>
                            <!--<input type="text" class="form-control" name="txtimg" id="" aria-describedby="" required><br>-->
                            <!--<label for="exampleFormControlFile1">Imagen</label>
                            <input type="file" class="form-control-file" id="exampleFormControlFile1" multiple required><br>-->
                            <button class="btn btn-outline-primary" name="accion" value="registrarProducto">Registrar Producto</button>
