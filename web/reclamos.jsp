...
<html>
    <head>
        ...
        <title>Solicitud o Reclamo</title>
    ...
    <body>
        ...
        <main>
            <div class="container">
                <div id="capa0">
                    <h1 id="titulo">Realiza una solicitud o reclamo</h1>
                    <hr>
                    <div id="capa1">
                        <form class="form-group" action="Controlador" method="post" enctype="multipart/form-data">
                            <%
                                if (bUsuario.getId_perfil() == 3) {
                            %>
                            <input id="" name="txtcodcli" type="hidden" value="<%=bUsuario.getCod_user()%>" required focus>
                            <label for="">Username</label>
                            <input type="text" class="form-control" name="txtusername" value="<%=bUsuario.getUsername()%>" id="" aria-describedby="" readonly="readonly" required focus>
                            <%}%>
                            <label for="">Asunto</label>
                            <select class="form-control" name="asuntosolicitud" id="asunto" required focus>
                                <option>Seleccione</option>
                                <option value="PEDIDOS">Pedido de un producto</option>
                                <option value="RECLAMOS">Reclamo o Sugerencia</option>
                            </select><br>
                            <label for="">Descripcion</label>
                            <textarea class="form-control" name="txtdescripcion" rows="5" id="" aria-describedby="" required></textarea><br>
                            <label for="">Subir archivo</label>
                            <input type="file" name="fileimagen" class="form-control"><br>
                            <button class="btn btn-outline-primary" name="accion" value="registrarSolicitud">Registrar Solicitud</button>
                        </form>
                    </div>
                </div>
            </div>
